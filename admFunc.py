...
def showVotes(root,frame1):
    ...
    bjpLogo = ImageTk.PhotoImage((Image.open("img/ccc.png")).resize((35,35),Image.ANTIALIAS))
    ...
    Label(frame1, text="CCC              :       ", font=('Helvetica', 12, 'bold')).grid(row = 2, column = 1)
    Label(frame1, text=result['ccc'], font=('Helvetica', 12, 'bold')).grid(row = 2, column = 2)
    ...
    Label(frame1, text=" MDC               :          ", font=('Helvetica', 12, 'bold')).grid(row = 4, column = 1)
    Label(frame1, text=result['mdc'], font=('Helvetica', 12, 'bold')).grid(row = 4, column = 2)

    Label(frame1, text=" ZAPU    :          ", font=('Helvetica', 12, 'bold')).grid(row = 5, column = 1)
    Label(frame1, text=result['zapu'], font=('Helvetica', 12, 'bold')).grid(row = 5, column = 2)
